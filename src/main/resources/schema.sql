...
INSERT INTO sender_types (sender_type_id, sender_type) VALUES
  (1, '農民'),
  (2, '農藥商'),
  (3, '其他');
...
INSERT INTO cities (city_id, city, sort_order) VALUES
  (1,  '臺北市', 1),
  (2,  '臺中市', 2),
  (3,  '基隆市', 3),
  (4,  '臺南市', 4),
...
INSERT INTO districts (district_id, district, city_id, sort_order) VALUES
  (1,   '中正區', 1, 1),
  (2,   '大同區', 1, 2),
  (3,   '中山區', 1, 3),
  (4,   '松山區', 1, 4),
...
CREATE INDEX idx_districts_sort   ON districts(city_id, sort_order);
...
INSERT INTO pest_types (pest_type_id, pest_type) VALUES
  (1, '病害'),
  (2, '蟲害'),
  (3, '有害動物'),
  (4, '生理因子'),
...
INSERT INTO pest_categories (pest_category_id, pest_category_code, pest_category, pest_type_id, sort_order) VALUES
  (1,  'A01', '真菌', 1, 10),
  (2,  'A02', '細菌', 1, 20),
  (3,  'A03', '病毒', 1, 30),
  (4,  'A04', '線蟲', 1, 40),
  ...
  (57, 'E03', '其他服務', 5, 30),
  (58, 'E00', '未知', 5, 99);
CREATE INDEX idx_pest_categories_pest_type_id ON pest_categories(pest_type_id);
CREATE INDEX idx_pest_categories_sort        ON pest_categories(pest_type_id, sort_order);
...
INSERT INTO crop_categories (crop_category_id, crop_category) VALUES
  (1, '糧食作物'),
  (2, '雜糧'),
  (3, '特用作物'),
  (4, '蔬菜及瓜果類'),
...
CREATE INDEX idx_crops_crop_category_id ON crops(crop_category_id);
...
INSERT INTO damages (damage_id, damage) VALUES
  (1, '根'),
  (2, '莖'),
  (3, '葉'),
  (4, '花'),
...
INSERT INTO hints (hint_id, hint) VALUES
  (1, '耕作防治'),
  (2, '物理防治'),
  (3, '生物防治'),
  (4, '化學防治'),
...
INSERT INTO deliveries (deliver_id, deliver) VALUES
  (1, '郵寄'),
  (2, '親送'),
  (3, '電話'),
  (4, '傳真'),
...
CREATE INDEX idx_senders_district_id    ON senders(district_id);
CREATE INDEX idx_senders_sender_type_id ON senders(sender_type_id);
...
CREATE INDEX idx_case_damages_case_id   ON case_damages(case_id);
CREATE INDEX idx_case_damages_damage_id ON case_damages(damage_id);
...
CREATE INDEX idx_case_hints_hint_id ON case_hints(hint_id);

-- ============================================================
-- case_pest_categories（案件 × 病蟲害小分類 junction）
-- ============================================================
CREATE TABLE case_pest_categories (
...
CREATE INDEX idx_case_pest_categories_case_id   ON case_pest_categories(case_id);
CREATE INDEX idx_case_pest_categories_pest_id   ON case_pest_categories(pest_category_id);
...
CREATE INDEX idx_case_identifiers_case_id       ON case_identifiers(case_id);
CREATE INDEX idx_case_identifiers_identifier_id ON case_identifiers(identifier_id);
