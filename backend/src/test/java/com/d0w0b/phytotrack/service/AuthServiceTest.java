...
class AuthServiceTest {
  ...
  void register_shouldEncodePasswordAndAssignViewerRole () {
    ...
    UserResponse response = authService.register (new RegisterRequest ("junit-user", "測試使用者", "secret123", null));
  ...
  void register_shouldRejectDuplicateUsername () {
    ...
    assertThatThrownBy (() -> authService.register (new RegisterRequest ("admin", "分身", "secret123", null)))
